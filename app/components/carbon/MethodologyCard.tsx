    ...
    <div className="bg-white p-6 rounded-2xl border border-gray-100 shadow-sm space-y-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="p-4 bg-yellow-50 border border-yellow-100 rounded-xl space-y-2">
          ...
          <div className="text-[11px] space-y-0.5 text-gray-500 font-mono">
            <p>Listrik PLN (Jawa-Madura-Bali): <span className="text-gray-700 font-semibold">0,87</span> kg/kWh</p>
            <p>Listrik PLN (Sumatera): <span className="text-gray-700 font-semibold">0,93</span> kg/kWh</p>
        ...
        <div className="p-4 bg-blue-50 border border-blue-100 rounded-xl space-y-2">
          ...
          <p className="text-[10px] text-gray-400">Sumber angka: DEFRA Pemerintah UK</p>
        </div>
      </div>
      ...
      <div className="bg-teal-50 border border-teal-100 rounded-xl p-4 flex gap-3">
        ...
        <div className="text-xs text-teal-800 space-y-1.5">
          <p className="font-bold">✓ Listrik Jawa-Madura-Bali dan Sumatera sudah pakai angka resmi</p>
          <p className="text-teal-700 leading-relaxed">
            Kalau site kamu ada di Sumatera Selatan, Lampung, atau provinsi Sumatera lainnya, angka yang dipakai
            adalah <strong>0,93 kg CO₂ per kWh</strong> — bukan disamakan dengan grid Jawa-Madura-Bali
            (<strong>0,87 kg CO₂ per kWh</strong>). Kedua angka ini diambil dari dokumen resmi yang sama
            ("Faktor Emisi GRK Sistem Ketenagalistrikan Tahun 2019", Kepmen ESDM No. 163.K/HK.02/MEM.S/2021),
            bukan perkiraan dan bukan dari tahun data yang berbeda.
          </p>
        </div>
      </div>
      ...
      <div className="bg-amber-50 border border-amber-100 rounded-xl p-4 flex gap-3">
        ...
        <div className="text-xs text-amber-800 space-y-1">
          <p className="font-bold">Limitasi Perhitungan</p>
          <ul className="list-disc list-inside space-y-0.5 text-amber-700">
            <li>Saat ini baru ada angka listrik untuk wilayah <strong>Jawa-Madura-Bali</strong> dan <strong>Sumatera</strong>. Wilayah Kalimantan, Sulawesi, dan Indonesia Timur belum punya angka khusus.</li>
      ...
      <div className="flex flex-wrap gap-4 pt-2 border-t border-gray-100 text-xs font-medium">
        ...
        <a href="https://www.esdm.go.id/assets/media/content/content-faktor-emisi-bahan-bakar-minyak-bbm-dan-batubara.pdf" target="_blank" rel="noreferrer"
          className="flex items-center gap-1 text-emerald-600 hover:text-emerald-700 transition hover:underline">
          Data BBM ESDM RI <ExternalLink size={11} />
        </a>
